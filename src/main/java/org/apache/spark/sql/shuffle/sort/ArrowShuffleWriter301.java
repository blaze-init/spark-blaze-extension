...
public class ArrowShuffleWriter301<K, V> extends ShuffleWriter<K, V> {
    ...
    @Nullable
    private ArrowShuffleExternalSorter301 sorter;
    ...
    private void open() {
        assert (sorter == null);
        sorter = new ArrowShuffleExternalSorter301(
            memoryManager,
            blockManager,
            taskContext,
     ...
     * the NIO-based merge, {@link ArrowShuffleWriter301#mergeSpillsWithTransferTo(SpillInfo[],
